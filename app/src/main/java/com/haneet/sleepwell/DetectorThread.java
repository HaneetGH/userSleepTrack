...
public class DetectorThread extends Thread {
	...
	private com.haneet.sleepwell.RecorderThread recorder;
	private volatile Thread _thread;
	private WaveHeader waveHeader;
	private com.haneet.sleepwell.SnoringApi snoringApi;
	// ----------------------------------
	Handler alarmhandler;

	// ----------------------------------

	public DetectorThread(com.haneet.sleepwell.RecorderThread recorder, Handler alarmhandler) {
		...
		snoringApi = new com.haneet.sleepwell.SnoringApi(waveHeader);
	}
		...
		try {
			...
			while (_thread == thisThread) {
				...
				if (buffer != null) {
					...
					// no sound detected
					com.haneet.sleepwell.MainActivity.snoreValue = 0;
				}
				// end audio analyst
			}
		} catch (Exception e) {
