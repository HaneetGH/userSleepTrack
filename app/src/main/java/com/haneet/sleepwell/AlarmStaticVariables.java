...
public class AlarmStaticVariables {
	...
	public static double level0 = 0.0;// vibration
	public static double level1 = 5000.0;
	public static double level2 = 10000.0;
	public static double level3 = 15000.0;
	public static double level4 = 20000.0;
